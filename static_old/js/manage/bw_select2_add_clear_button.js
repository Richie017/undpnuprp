...
$(function () {
    ...
    $add_all.change(function () {
        ...
        if (add_all == true) {
            ...
            if ($this_select2.length == 0) {
                $this_select2 = $(this).parent().parent().find('input.bw-select2[data-js-url]');
    ...
    $('input.bw-select2').change(function () {
        var total_items = select2_values[$(this).attr('id')];
