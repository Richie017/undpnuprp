...
class DynamicQuestionResponse(OrganizationDomainEntity):
    section_response = models.ForeignKey('dynamic_survey.DynamicSectionResponse')
    question = models.ForeignKey('dynamic_survey.DynamicQuestion')
    answer = models.ForeignKey('dynamic_survey.DynamicAnswer')
