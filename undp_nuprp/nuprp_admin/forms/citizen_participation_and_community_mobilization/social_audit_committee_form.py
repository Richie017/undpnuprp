...
from undp_nuprp.nuprp_admin.models.citizen_participation_and_community_mobilization.social_audit_committee import \
...
class SocialAuditCommitteeForm(GenericFormMixin):
    def __init__(self, data=None, files=None, instance=None, prefix='', **kwargs):
        super(SocialAuditCommitteeForm, self).__init__(
    ...
    class Meta(GenericFormMixin.Meta):
        model = SocialAuditCommittee

        fields = [
            'year', 'city', 'ward_no', 'total_committee_formed',
            'trained', 'male', 'female', 'disabled'
        ]
    ...
    def save(self, commit=True):
        ...
        return super(SocialAuditCommitteeForm, self).save(commit=commit)
