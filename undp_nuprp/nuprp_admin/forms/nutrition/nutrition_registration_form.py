...
class NutritionRegistrationForm(GenericFormMixin):
    def __init__(self, data=None, files=None, instance=None, prefix='', **kwargs):
        super(NutritionRegistrationForm, self).__init__(data=data, files=files, instance=instance,
    ...
    def field_groups(cls):
        _group = super(NutritionRegistrationForm, cls).field_groups()
