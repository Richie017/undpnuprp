...
@decorate(is_object_context, is_role_context,
          route(route='local-government-official', group='Users', module=ModuleEnum.Settings,
                display_name='Local Government Official', group_order=1, item_order=8))
class LocalGovernmentOfficial(ConsoleUser):
    class Meta:
