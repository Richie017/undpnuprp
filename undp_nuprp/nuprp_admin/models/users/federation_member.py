...
@decorate(is_object_context, is_role_context,
          route(route='federation-member', group='Users', module=ModuleEnum.Settings,
                display_name='Federation Member', group_order=1, item_order=8))
class FederationMember(ConsoleUser):
    class Meta:
