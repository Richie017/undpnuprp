...
@decorate(is_object_context, is_role_context,
          route(route='senior-management', group='Users', module=ModuleEnum.Settings,
                display_name='Senior Management', group_order=1, item_order=8))
class SeniorManagement(ConsoleUser):
    class Meta:
