...
@decorate(is_object_context, is_role_context,
          route(route='monitoring-official', group='Users', module=ModuleEnum.Settings,
                display_name='Governance and Mobilization Expert', group_order=1, item_order=1))
class MonitoringOfficial(ConsoleUser):
    class Meta:
