...
@decorate(is_object_context, is_role_context,
          route(route='housing-infrastructure-expert', group='Users', module=ModuleEnum.Settings,
                display_name='Housing & Infrastructure Expert', group_order=1, item_order=8))
class HIExpert(ConsoleUser):
    class Meta:
