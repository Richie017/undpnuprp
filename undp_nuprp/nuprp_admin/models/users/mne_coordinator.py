...
@decorate(is_object_context, is_role_context,
          route(route='mne-coordinator', group='Users', module=ModuleEnum.Settings,
                display_name='M&E Co-ordinator', group_order=1, item_order=3, hide=True))
class MNECoordinator(ConsoleUser):
    @property
