...
@decorate(is_object_context, is_role_context,
          route(route='mne-specialist', group='Users', module=ModuleEnum.Settings,
                display_name='MNE Specialist', group_order=1, item_order=2, hide=True))
class MNESpecialist(ConsoleUser):
    @property
