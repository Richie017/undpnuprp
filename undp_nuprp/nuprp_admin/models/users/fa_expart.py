...
@decorate(is_object_context, is_role_context,
          route(route='fa-expert', group='Users', module=ModuleEnum.Settings,
                display_name='Finance & Administration Expert', group_order=1, item_order=8))
class FAExpert(ConsoleUser):
    class Meta:
