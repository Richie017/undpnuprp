...
@decorate(is_object_context, is_role_context,
          route(route='mis-specialist', group='Users', module=ModuleEnum.Settings,
                display_name='MIS Specialist', group_order=1, item_order=4, hide=True))
class MISSpecialist(ConsoleUser):
    @property
