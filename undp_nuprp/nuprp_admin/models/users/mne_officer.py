...
@decorate(is_object_context, is_role_context,
          route(route='monitoring-officer', group='Users', module=ModuleEnum.Settings,
                display_name='Regional Monitoring Officer', group_order=1, item_order=7))
class MNEOfficer(ConsoleUser):
    @property
