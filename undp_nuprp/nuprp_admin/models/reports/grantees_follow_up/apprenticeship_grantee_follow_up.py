...
@decorate(is_object_context,
          route(route='apprenticeship-grantee-follow-up', group='Grants', module=ModuleEnum.Execute,
                display_name='Apprenticeship Grant Follow Up', group_order=2, item_order=1))
class ApprenticeshipGranteeFollowUp(GranteeFollowUp):
    ...
    def table_columns(cls):
        return ('render_code', 'grantee', 'date_of_last_installment',
                ...
                'current_employment_status:Current employment status (multiple option can be selected)',
    ...
    def details_config(self):
        ...
        details['Current employment status (multiple option can be selected)'] = self.current_employment_status
