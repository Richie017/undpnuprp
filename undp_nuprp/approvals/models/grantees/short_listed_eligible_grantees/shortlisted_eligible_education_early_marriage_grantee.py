...
@decorate(is_object_context, enable_import, route(
    route='shortlisted-eligible-education-early-marriage-grantee', module=ModuleEnum.Analysis,
    group='Local Economy Livelihood and Financial Inclusion', group_order=3, item_order=8,
    display_name='Short Listed Education Grantees (Reduce Early Marriage)'
))
class ShortListedEligibleEducationEarlyMarriageGrantee(ShortListedEligibleGrantee):
    class Meta:
        app_label = 'approvals'
        proxy = True
