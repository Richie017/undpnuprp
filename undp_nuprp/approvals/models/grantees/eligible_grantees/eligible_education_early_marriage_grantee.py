...
@decorate(is_object_context, enable_export,
          route(route='eligible-education-early-marriage-grantee',
                group='Local Economy Livelihood and Financial Inclusion',
                module=ModuleEnum.Analysis, group_order=3,
                display_name='Eligibles for Education Grant (Reduce Early Marriage)', item_order=4))
class EligibleEducationEarlyMarriageGrantee(EligibleEducationGrantee):
    class Meta:
        app_label = 'approvals'
        proxy = True
