...
@decorate(is_object_context, enable_export,
          route(route='eligible-grantee-ward', group='Local Economy Livelihood and Financial Inclusion',
                module=ModuleEnum.Analysis,
                group_order=3, display_name='Eligibles Grant for Ward', item_order=1))
class EligibleGranteeWard(EligibleGrantee):
