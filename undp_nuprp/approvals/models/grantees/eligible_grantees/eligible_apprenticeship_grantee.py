...
@decorate(is_object_context, enable_export,
          route(route='eligible-apprenticeship-grantee', group='Local Economy Livelihood and Financial Inclusion',
                module=ModuleEnum.Analysis,
                group_order=3, display_name='Eligibles for Apprenticeship Grant', item_order=2))
class EligibleApprenticeshipGrantee(EligibleGrantee):
