...
@decorate(is_object_context, enable_export,
          route(route='eligible-business-grantee', group='Local Economy Livelihood and Financial Inclusion',
                module=ModuleEnum.Analysis,
                group_order=3, display_name='Eligibles for Business Grant', item_order=1))
class EligibleBusinessGrantee(EligibleGrantee):
    ...
    @property
    def render_grant_interested(self):
