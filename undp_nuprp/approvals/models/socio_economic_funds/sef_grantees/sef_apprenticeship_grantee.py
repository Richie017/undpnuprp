...
@decorate(is_object_context,
          route(route='sef-apprenticeship-grantee', group='Local Economy Livelihood and Financial Inclusion',
...
class SEFApprenticeshipGrantee(SEFGrantee):
    ...
    def table_columns(cls):
        return (
            ...
            "trade_sector:Type of Trade", "render_grant_disbursement_year",
    ...
    def details_config(self):
        ...
        basic_info['which_trade'] = self.trade_sector
        basic_info['Is the grantee still attending the training?'] = self.is_still_attending_training
    ...
    def export_file_columns(cls):
        ...
        _table_columns = ["code", "name:Beneficiary Name", "render_contact_number", "render_PG_member_ID",
                          ...
                          "relation_with_pg_member:Relationship of grantee to PG member", "trade_sector:Type of Trade",
    ...
    def details_view_fields(cls):
        ...
        """
        return ['age', 'gender', 'grantee_status', 'remarks', 'is_still_attending_training', 'has_disability',
                'difficulty_in_seeing',
                'difficulty_in_hearing', 'difficulty_in_walking', 'difficulty_in_remembering',
