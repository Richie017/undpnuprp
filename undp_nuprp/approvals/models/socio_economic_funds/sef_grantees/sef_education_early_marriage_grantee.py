...
@decorate(is_object_context,
          route(route='sef-education-early-marriage-grantee', group='Local Economy Livelihood and Financial Inclusion',
                module=ModuleEnum.Analysis,
                display_name='Education Grantees (Early Child Marriage)', group_order=3, item_order=12))
class SEFEducationChildMarriageGrantee(SEFGrantee):
    ...
    def details_config(self):
        ...
        basic_info['Is the grantee married?'] = self.marital_status
    ...
    def export_file_columns(cls):
        ...
        _table_columns = ["code", "name:Beneficiary Name", "render_contact_number", "render_PG_member_ID",
                          "render_pg_member_name", "render_CDC_name", "render_CDC_ID", "render_city_corporation",
                          "ward", "relation_with_pg_member:Relationship of grantee to PG member",
    ...
    def details_view_fields(cls):
        ...
        """
        return ['age', 'gender', 'education_level', 'marital_status', 'grantee_status', 'remarks',
