...
class SEFEducationChildMarriageGrantDisbursementForm(SEFGrantDisbursementForm):
    education_level = forms.CharField()
    marital_status = forms.CharField()

    def __init__(self, data=None, files=None, instance=None, prefix='', **kwargs):
        super(SEFEducationChildMarriageGrantDisbursementForm, self).__init__(
            data=data, files=files, instance=instance.sefeducationchildmarriagegrantee if instance else None,
            prefix=prefix,
            **kwargs
        )
    ...
    class Meta(GenericFormMixin.Meta):
        model = SEFEducationChildMarriageGrantDisbursement
        fields = (
            ...
            'education_level', 'marital_status', 'remarks'
        )
        widgets = {
    ...
    def field_groups(cls):
        _group = super(SEFEducationChildMarriageGrantDisbursementForm, cls).field_groups()
        _group['Grantee\'s Basic Information'] = \
            ['name', 'contact_number', 'account_number', 'age', 'gender', 'pg_member_assigned_code', 'pg_member_name',
             'relation_with_pg_member', 'education_level', 'marital_status', 'remarks']
