...
from undp_nuprp.reports.config.pg_member_information_indicators import pg_member_information_indicators
...
@decorate(override_view(model=PGMemberInformationReport, view=ViewActionEnum.Manage))
class PGMemberInformationReportView(GenericReportView):
    def get(self, request, *args, **kwargs):
        return super(PGMemberInformationReportView, self).get(request, *args, **kwargs)

    def get_indicators(self, **kwargs):
        return pg_member_information_indicators

    def get_context_data(self, **kwargs):
        context = super(PGMemberInformationReportView, self).get_context_data(**kwargs)
        context['title'] = "PG Member Information"
    ...
    def get_json_response(self, content, **kwargs):
        ...
        report_data = PGMemberInformationReport().build_report(indicator=indicator, graph_type=graph_type)
        ...
        return super(PGMemberInformationReportView, self).get_json_response(
