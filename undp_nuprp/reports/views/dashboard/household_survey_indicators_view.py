...
from undp_nuprp.reports.config.survey_indicators import household_survey_indicators
...
@decorate(override_view(model=HouseholdSurveyIndicatorReport, view=ViewActionEnum.Manage))
class HouseholdSurveyIndicatorView(GenericReportView):
    def get(self, request, *args, **kwargs):
        return super().get(request, *args, **kwargs)

    def get_indicators(self, **kwargs):
        return household_survey_indicators

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = "Household Survey Indicators"
    ...
    def get_json_response(self, content, **kwargs):
        ...
        report_data = HouseholdSurveyIndicatorReport().build_report(from_time=f_date, to_time=t_date, wards=ward_ids,
