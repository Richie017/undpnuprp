...
from undp_nuprp.reports.config.crmif_indicator import crmif_indicator
...
@decorate(override_view(model=CRMIFReport, view=ViewActionEnum.Manage))
class CRMIFReportView(BaseSIFCRMIFReportView):
    def get_indicators(self, **kwargs):
        return crmif_indicator
    ...
    def get_json_response(self, content, **kwargs):
        ...
        report_data = CRMIFReport().build_report(from_time=f_date, to_time=t_date, wards=ward_ids,
