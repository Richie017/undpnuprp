...
from undp_nuprp.reports.utils.graph_config.high_chart_configs import get_stacked_column_chart_config, \
    get_column_chart_config, get_bar_chart_config, get_scatter_chart_config, get_flat_html_config, get_pie_chart_config
...
class BaseSIFCRMIFReportView(GenericReportView):
    def get(self, request, *args, **kwargs):
        return super(BaseSIFCRMIFReportView, self).get(request, *args, **kwargs)
    ...
    def get_report_parameters(self, **kwargs):
        parameters = super(BaseSIFCRMIFReportView, self).get_report_parameters(**kwargs)
    ...
    def get_template_names(self):
        return ['reports/base_sif_crmif_indicator.html']
