...
from undp_nuprp.reports.config.pg_hh_head_information_indicators import pg_hh_head_information_indicators
...
@decorate(override_view(model=PGHHHeadInformationReport, view=ViewActionEnum.Manage))
class PGHHHeadInformationReportView(GenericReportView):
    def get(self, request, *args, **kwargs):
        return super(PGHHHeadInformationReportView, self).get(request, *args, **kwargs)

    def get_indicators(self, **kwargs):
        return pg_hh_head_information_indicators

    def get_context_data(self, **kwargs):
        context = super(PGHHHeadInformationReportView, self).get_context_data(**kwargs)
        context['title'] = "PG HH Head Information"
    ...
    def get_json_response(self, content, **kwargs):
        ...
        report_data = PGHHHeadInformationReport().build_report(indicator=indicator, graph_type=graph_type)
        ...
        return super(PGHHHeadInformationReportView, self).get_json_response(
