...
o_and_m_funds_indicator = [
    {
        'name': '% of CDCs with O&M funds',
    ...
    {
        'name': 'Number of CDCs with O&M funds',
        'full_name': 'Value of savings generated from savings and credit groups',
        'indicator': HouseholdSurveyIndicatorEnum.DemoIndicator.value,
        'graph_types': [
            {
    ...
    {
        'name': '% of SIF projects for which there is an O&M fund',
        'full_name': 'Value of savings generated from savings and credit groups',
        'indicator': HouseholdSurveyIndicatorEnum.DemoIndicator.value,
        'graph_types': [
            {
    ...
    {
        'name': '% of CRMIF projects for which there is an O&M fund',
        'full_name': 'Value of savings generated from savings and credit groups',
        'indicator': HouseholdSurveyIndicatorEnum.DemoIndicator.value,
        'graph_types': [
            {
    ...
    {
        'name': 'Current value of O&M funds',
        'full_name': 'Value of savings generated from savings and credit groups',
        'indicator': HouseholdSurveyIndicatorEnum.DemoIndicator.value,
        'graph_types': [
            {
