...
class ConsoleUser(OrganizationDomainEntity):
    ...
    bank_details = models.OneToOneField(BankAccountDetails, null=True, on_delete=models.SET_NULL)
    mobile_banking_details = models.OneToOneField(MobileBankingDetails, null=True, on_delete=models.SET_NULL)
    education = models.OneToOneField(EducationalQualification, null=True, on_delete=models.SET_NULL)
    image = models.ForeignKey(ImageFileObject, null=True, default=None, on_delete=models.SET_NULL)
