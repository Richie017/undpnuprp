...
class ClientMeta(OrganizationDomainEntity):
    ...
    nid_image = models.ForeignKey(ImageFileObject, null=True, default=None, on_delete=models.SET_NULL)
    p_photo = models.ForeignKey(ImageFileObject, null=True, default=None, related_name="personal_photo", on_delete=models.SET_NULL)
