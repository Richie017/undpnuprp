...
"""
github url of dropbox storage
https://github.com/squareweave/django-storages/tree/dropbox-8.2.0-support
"""
...
from blackwidow.dbmediabackup.utils.storages.dropbox_storage.dropbox_utils import setting
...
class DropBoxFile(File):
    ...
    def file(self):
        if not hasattr(self, '_file'):
            ...
            self._storage.client.files_download_to_file(self._file.name, self.name)
            self._file.seek(0)
...
class DropBoxStorage(Storage):
    ...
    def __init__(self, oauth2_access_token=None, root_path=None):
        ...
        self.client = Dropbox(oauth2_access_token, timeout=None)
